...
class AvatarImageView @JvmOverloads constructor(
    ...
    companion object {
        ...
        fun initialsToColor(letters: String): Int {
            val byte = (letters.getOrNull(0) ?: 'a').toByte()
    ...
    init {
        if (attrs != null) {
            val attrsArray = context.obtainStyledAttributes(attrs, R.styleable.AvatarImageView)
            ...
            initials = attrsArray.getString(R.styleable.AvatarImageView_aiv_initials) ?: "??"
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        setMeasuredDimension(initSize, maxSize)
    }
