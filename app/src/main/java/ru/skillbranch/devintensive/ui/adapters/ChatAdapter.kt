...
class ChatAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChatItemViewHolder {
        ...
        return when (viewType) {
            SINGLE_TYPE -> {
                SingleViewHolder(inflater.inflate(R.layout.item_chat_single, parent, false))
            }
            GROUP_TYPE -> {
                GroupViewHolder(inflater.inflate(R.layout.item_chat_group, parent, false))
            }
            else -> {
                ArchiveViewHolder(inflater.inflate(R.layout.item_chat_archive, parent, false))
            }
        }
    }
    ...
    inner class SingleViewHolder(
        ...
        override fun onItemSelected() {
            with(itemView) {
                setBackgroundColor(context.getModeColor(R.attr.colorSelected))
            }
        }

        override fun onItemCleared() {
            with(itemView) {
                setBackgroundColor(context.getModeColor(R.attr.colorItemView))
            }
        }
        ...
        override fun bind(item: ChatItem, listener: (ChatItem) -> Unit) {
            ...
            tv_message_single.text = item.shortDescription?.trim() ?: "Сообщений еще нет"
    ...
    inner class GroupViewHolder(
        ...
        override fun bind(item: ChatItem, listener: (ChatItem) -> Unit) {
            ...
            tv_message_group.text = item.shortDescription?.trim() ?: "Сообщений еще нет"
    ...
    inner class ArchiveViewHolder(
        ...
        override fun bind(item: ChatItem, listener: (ChatItem) -> Unit) {
            ...
            tv_message_archive.text = item.shortDescription?.trim() ?: "Сообщений еще нет"
